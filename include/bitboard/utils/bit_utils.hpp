...
// constexpr bitboard row_a = (1ULL) + (1ULL << 8ULL) + (1ULL << 16ULL)
//     + (1ULL << 24ULL) + (1ULL << 32ULL) + (1ULL << 40ULL) + (1ULL << 48ULL)
//     + (1ULL << 56ULL);
...
// constexpr bitboard line_8 = (1ULL) + (1ULL << 1ULL) + (1ULL << 2ULL)
//     + (1ULL << 3ULL) + (1ULL << 4ULL) + (1ULL << 5ULL) + (1ULL << 6ULL)
//     + (1ULL << 7ULL);
